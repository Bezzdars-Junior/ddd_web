...
class CardProject extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GridView.count(
      ...
      crossAxisCount: 5,
      childAspectRatio: 3,
      children: List.generate(model.projects.length, (index) {
        return Stack(
          children: [
            Container(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Дата создания: ${model.projects[index].dateTime}',
                          overflow: TextOverflow.ellipsis,
                        ),
                        Text(
                          'Дата изменения: ${model.projects[index].dateChange}',
                          overflow: TextOverflow.ellipsis,
                        ),
                        Text(
                          'Описание: ${model.projects[index].description}',
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ],
